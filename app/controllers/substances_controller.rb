class SubstancesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @substance.save
        format.html { redirect_to substances_url, notice: 'Substance was successfully created.' }
        format.json { render action: 'show', status: :created, location: @substance }
      else
  ...
  private
    ...
    def substance_params
      params.require(:substance).permit(:name, :quantity)
    end
end
